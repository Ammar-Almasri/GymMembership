...
namespace GymMembership {
    ...
    public partial class GymDataSet : global::System.Data.DataSet {
        ...
        public partial class PaymentsDataTable : global::System.Data.TypedTableBase<PaymentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PaymentsRow AddPaymentsRow(int MemberID, decimal Amount, string CreditCardNumber) {
        ...
        public partial class PaymentsRow : global::System.Data.DataRow {
            ...
            public string CreditCardNumber {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'CreditCardNumber\' in table \'Payments\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsCreditCardNumberNull() {
                return this.IsNull(this.tablePayments.CreditCardNumberColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetCreditCardNumberNull() {
                this[this.tablePayments.CreditCardNumberColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace GymMembership.GymDataSetTableAdapters {
    ...
    public partial class PaymentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Payments] WHERE (([PaymentID] = @Original_PaymentID) AND ([MemberID] = @Original_MemberID) AND ([Amount] = @Original_Amount) AND ((@IsNull_CreditCardNumber = 1 AND [CreditCardNumber] IS NULL) OR ([CreditCardNumber] = @Original_CreditCardNumber)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Payments] ([MemberID], [Amount], [CreditCardNumber]) VALUES (@" +
                "MemberID, @Amount, @CreditCardNumber);\r\nSELECT PaymentID, MemberID, Amount, Cred" +
                "itCardNumber FROM Payments WHERE (PaymentID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Payments] SET [MemberID] = @MemberID, [Amount] = @Amount, [CreditCardNumber] = @CreditCardNumber WHERE (([PaymentID] = @Original_PaymentID) AND ([MemberID] = @Original_MemberID) AND ([Amount] = @Original_Amount) AND ((@IsNull_CreditCardNumber = 1 AND [CreditCardNumber] IS NULL) OR ([CreditCardNumber] = @Original_CreditCardNumber)));
SELECT PaymentID, MemberID, Amount, CreditCardNumber FROM Payments WHERE (PaymentID = @PaymentID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GymMembership.Properties.Settings.Default.GymConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PaymentID, MemberID, Amount, CreditCardNumber FROM dbo.Payments";
        ...
        public virtual int Delete(int Original_PaymentID, int Original_MemberID, decimal Original_Amount, string Original_CreditCardNumber) {
            ...
            if ((Original_CreditCardNumber == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((string)(Original_CreditCardNumber));
            }
        ...
        public virtual int Insert(int MemberID, decimal Amount, string CreditCardNumber) {
        ...
        public virtual int Update(int MemberID, decimal Amount, string CreditCardNumber, int Original_PaymentID, int Original_MemberID, decimal Original_Amount, string Original_CreditCardNumber, int PaymentID) {
            ...
            if ((Original_CreditCardNumber == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_CreditCardNumber));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int MemberID, decimal Amount, string CreditCardNumber, int Original_PaymentID, int Original_MemberID, decimal Original_Amount, string Original_CreditCardNumber) {
            return this.Update(MemberID, Amount, CreditCardNumber, Original_PaymentID, Original_MemberID, Original_Amount, Original_CreditCardNumber, Original_PaymentID);
        }
    }
